-- 용산구 panel 타입의 banner_slot_info 데이터 추가 (11, 17번) - 수정된 버전
-- max_width: 500, max_height: 70, total_price: 120000, banner_type: semi-auto
...
SELECT 
    ...
    10000 as tax_price,
    'semi-auto' as banner_type,  -- 수정: 'panel' → 'semi-auto'
