-- ✅ 올바른 재고 관리 함수 수정
-- banner_slot_inventory는 banner_slot_id 기준으로 관리되어야 함!
-- 실제 스키마: banner_slot_id, region_gu_display_period_id, is_available, is_closed
...
BEGIN
  ...
  ELSE
    ...
    -- (일반적으로는 panel_slot_usage_id가 있어야 함)
