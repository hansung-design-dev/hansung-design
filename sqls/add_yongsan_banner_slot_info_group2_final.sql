-- 용산구 semi-auto 타입의 banner_slot_info 데이터 추가 (11, 17번) - 최종 수정
-- max_width: 500, max_height: 70, total_price: 120000, banner_type: panel

-- 11번, 17번 (max_banner: 6개)에 대한 banner_slot_info 추가
...
WHERE rg.name = '용산구' 
AND pi.panel_type = 'semi-auto'  -- 수정: 'panel' → 'semi-auto'
AND pi.panel_code IN (11, 17)
