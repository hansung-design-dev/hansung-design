-- 용산구 상단광고 가격 정책 데이터 입력
-- panel_type과 banner_type 기준으로 상단광고 가격 정책 적용

-- 1. panel_type = 'with_lighting'인 상단광고 default 타입 가격
...
WHERE rg.name = '용산구'
  AND pi.panel_type = 'with_lighting'
...
-- 2. panel_type = 'no_lighting'인 상단광고 default 타입 가격
INSERT INTO banner_slot_price_policy (
    id,
    banner_slot_info_id,
    price_usage_type,
