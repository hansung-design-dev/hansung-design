...
const Section = ({
  ...
  return (
    <section className="h-screen lg:w-full flex items-center justify-center scroll-container sm:px-[0rem] sm:w-full md:w-[90%] md:px-[1rem] lg:px-[2rem]">
      <motion.div
      ...
      >
        ...
        >
          <div
            className={`flex lg:flex-col gap-[2rem]  md:gap-[2rem] max-w-xl md:pb-3 md:items-start sm:flex-col sm:pb-6 sm:gap-[2.5rem] lg:w-full ${
              reverse ? 'items-end text-right ml-auto' : 'items-start text-left'
            }`}
          >
            <div
              className={`flex flex-col  lg:gap-[5rem] sm:gap-[0.75rem] md:gap-[1.25rem] ${
